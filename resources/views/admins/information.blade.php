<x-admins.layout>
    ...
    <div class="max-w-xl">
        ...
        <div class="mb-4">
            ...
            <textarea name="address" class="border-gray-300 focus:border-gray-500 focus:ring-gray-500 rounded-md shadow-sm block mt-1 px-2 w-full" id="address" cols="30" rows="5">{{ old('address', $post->address) }}</textarea>
