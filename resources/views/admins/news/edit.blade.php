<x-admins.layout>
    <div class=" max-w-xl">
        ...
        <div class="mb-4">
            ...
            <textarea name="body" class="border-gray-300 focus:border-gray-500 focus:ring-gray-500 rounded-md shadow-sm block mt-1 px-2 w-full" id="body" cols="30" rows="10">{{ old('body', $new->body) }}</textarea>
